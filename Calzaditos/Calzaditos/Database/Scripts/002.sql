...
create table PromoCode(
	...
	Stock int not null,
	Code nvarchar(7) not null constraint UQ_PromoCode_Code unique, 
...
(20,35),(20,36),(20,37),(20,38),
(21,35),(21,36),(21,37),(21,38),
(22,35),(22,36),(22,37),(22,38),
(23,35),(23,36),(23,37),(23,38),
(24,35),(24,36),(24,37),(24,38),
(25,35),(25,36),(25,37),(25,38)

insert into PromoCode
(
	Amount, Code, stock, createdAt
)values
(30, 'UPC2024', 10, GETDATE()),
(10, 'CALZA10', 5, GETDATE()),
(20, 'CALZA20', 5, GETDATE()),
(25, 'CALZA25',3, GETDATE())